...
if not lspkind_status then
    vim.notify("Unable to require lspkind", vim.lsp.log_levels.ERROR, {title = "Plugin error"})
    return
end
...
cmp.setup({
    ...
    sources = {
        ...
        {name = "nvim_lua", priority_weight = 4, keyword_length = 2}, {name = "path", priority = 2, keyword_length = 2}
    },
